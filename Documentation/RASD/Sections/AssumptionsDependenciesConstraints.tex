...
\begin{enumerate}[label={D\arabic*.}]
    ...
    \myitem {Every city has authority istitutions.} \label{D_city_auth}
    \myitem {Municipality and authorities of each city have a PCE.} \label{D_pce}
    \myitem {Each nation's PCE service has an API to get the data of an istitution from a PCE.} \label{D_pce_api}
\end{enumerate}
